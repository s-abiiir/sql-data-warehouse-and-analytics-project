...
-- FIND TOTAL PRODUCTS BY PRODUCT LINE
SELECT 
	product_line,
	COUNT(product_key) AS total_products
FROM gold.dim_products
...
-- FIND TOTAL PRODUCTS BY MAINTENANCE
SELECT 
	maintenance,
	COUNT(product_key) AS total_products
FROM gold.dim_products
...
-- FIND AVERAGE COST PER PRODUCT LINE
SELECT 
	product_line,
	AVG(cost) AS avg_costs
FROM gold.dim_products
...
-- FIND TOTAL REVENUE GENERATED BY PRODUCT MAINTENANCE STATUS
SELECT 
	pr.maintenance,
	SUM(sa.sales_amount) AS total_revenue
FROM gold.fact_sales sa
...
-- FIND TOTAL REVENUE GENERATED BY EACH MARITAL STATUS
SELECT 
	cu.marital_status,
	SUM(sa.sales_amount) AS total_revenue
FROM gold.fact_sales sa
...
-- FIND TOTAL REVENUE GENERATED BY EACH GENDER
SELECT 
	cu.gender,
	SUM(sa.sales_amount) AS total_revenue
FROM gold.fact_sales sa
